...
public class RetryController {
    ...
    @Operation(summary = "Realiza uma chamada externa de API com Retry.",
            description = "Realiza uma chamada externa de API com o padrão de projeto Retry. O Retry será executado apenas em cenário de erros")
    @ApiResponses(value = {
